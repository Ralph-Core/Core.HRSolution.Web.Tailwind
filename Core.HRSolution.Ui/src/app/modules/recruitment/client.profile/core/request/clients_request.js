...
export const  GET_CLIENT_COMPANY_DASHBOARD_URL = `${config.API_URL}/recruitment/department/retrieve_dashboard_department_company`;
export const  POST_CREATE_COMPANY_PROFILE_URL = `${config.API_URL}/recruitment/department/create_department_company`;
export const  GET_CLIENT_COMPANY_PROFILE_URL = `${config.API_URL}/recruitment/department/retrieve_department_company_profile`;
export const  PUT_UPDATE_CLIENT_COMPANY_PROFILE_URL = `${config.API_URL}/recruitment/department/update_department_company`;
